...
{
    public partial class FrmIGEgrdx1 : Form
    {
        ...
        private void FrmDivNuevo_Resize(object sender, EventArgs e)
        {
        ...
        private void FrmDivNuevo_Shown(object sender, EventArgs e)
        {
        ...
        public FrmIGEgrdx1(string pcTablaCaso, string pcCampoIdTablaCaso)
        {
            InitializeComponent();
            ...
            switch (this.cTablaCaso)
            {
                case "GETPSUJETO":
                    ...
                    DataGridMain.Columns[1].HeaderText = "Tipo Sujeto";
                ...
                case "GETPENTIDAD":
                    ...
                    DataGridMain.Columns[1].HeaderText = "Tipo Entidad";
                ...
                case "GEAREADEPART":
                    ...
                    DataGridMain.Columns[1].HeaderText = "Area Dptal";
                ...
                case "GECLASEDOCUMENTO":
                    ...
                    DataGridMain.Columns[1].HeaderText = "Tipo Documento";
                    //cboTipo.Items.Add("RECIBO PAGO");
                    break;
                case "NOTPFAMILIAR":
                    lblTipo.Text = "Tipo Familiar";
                    DataGridMain.Columns[1].HeaderText = "Tipo Familiar";
                ...
                case "NOTPINDICADOR":
                    ...
                    DataGridMain.Columns[1].HeaderText = "Tipo Indicador";
                ...
                case "VETPCLIENTE":
                    ...
                    DataGridMain.Columns[1].HeaderText = "Tipo Cliente";
                ...
                case "NOTPASIGNACION":
                    ...
                    DataGridMain.Columns[1].HeaderText = "Tipo Asignación";
                ...
                case "NOTPJUSTIFICATIVO":
                    ...
                    DataGridMain.Columns[1].HeaderText = "Tipo Justificativo";
                    //cboTipo.Items.Add("");                   
                    break;
                case "NOTPDEDUCCION":
                    lblTipo.Text = "Tipo Deducción";
                    DataGridMain.Columns[1].HeaderText = "Tipo Deducción";
                    //cboTipo.Items.Add("");                   
                    break;
            }
        ...
        private void procesar()
        {
            ...
            if (bResult)
            {
                ...
                if (this.idActual == "")
                {
                    //this.cTablaCaso trae el nombre de la Tabla del caso para relacionarla con GEDIVXCLASIF
                    if(this.cTablaCaso== "NOTPJUSTIFICATIVO" || this.cTablaCaso == "NOTPDEDUCCION")
                    {
                        con.Insertar(this.cTablaCaso, "IDGEDIVXCLASIF,INACTIVO", cUltimoID+",1");
                    }
                    else
                    {
        ...
        private void tableLayoutPExterno_Paint(object sender, PaintEventArgs e)
        {
