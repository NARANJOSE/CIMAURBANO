...
{
    public partial class FrmDGEgrdx1 : Form
    {
        ...
        private void FrmDGEgrdx1_Resize(object sender, EventArgs e)
        {
        ...
        private void FrmDGEgrdx1_Shown(object sender, EventArgs e)
        {
        ...
        public FrmDGEgrdx1(string pcTablaCaso, string pcCampoIdTablaCaso)
        {
            InitializeComponent();
            ...
            switch (this.cTablaCaso)
            {
                case "GECLASEDOCUMENTO":
                    ...
                    DataGridMain.Columns[2].HeaderText = "Clase";
        ...
        private void cargarGrid()
        {
            ...
            parametros[2] = new Parametros("@PTB2", "GEAREADEPART");
            parametros[3] = new Parametros("@PCAMPOSTB2", "TB2.NOMBRE AS DEPART");
            parametros[4] = new Parametros("@PCAMPOIDTB2", "IDAREADEPARTAMENTAL");
            ...
            if (con.tabla.Rows.Count > 0)
            {
                ...
                DataGridMain.Columns["area"].DataPropertyName = "DEPART";
        ...
        {
            FrmFiltro FrmDivxClasif = new FrmFiltro("GEAREADEPART", "IDAREADEPARTAMENTAL");
            FrmDivxClasif.ReturnID += new FrmFiltro.DelegadoReturn(CargarID);
            FrmDivxClasif.ShowDialog();

            if (this.idCombo != "")
            {
                cboAreaD.SelectedValue = Convert.ToInt32(this.idCombo);
            }            
        }

        void CargarID(string valorID)
        {
            this.idCombo = valorID;
        }
    }
}
